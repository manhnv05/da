...
public class Menu extends javax.swing.JPanel {
    ...
    private void initData() {
        listMenu.addItem(new Model_Menu("1", "Sản phẩm", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("2", "Bán hàng", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Hoá đơn", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("4", "Giảm giá", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/8_selected.png"))); // NOI18N
        jLabel1.setText("TSHAT");
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#3b5998"), 0, getHeight(), Color.decode("#3b5998"));
        g2.setPaint(g);
